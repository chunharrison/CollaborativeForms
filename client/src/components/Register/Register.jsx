            ...
            <div className="register-container">
                {
                    ...
                    <div className="social-login-container">
                            <div className="social-login-button">
                                <a
                                href={`${process.env.REACT_APP_BACKEND_ADDRESS}/auth/google`} id="google-login-button" className="social-login-link">
                                <svg 
                            ...
                            <div className="social-login-button">
                                <a
                                href={`${process.env.REACT_APP_BACKEND_ADDRESS}/auth/facebook`} id="facebook-login-button" className="social-login-link">
                            ...
                            <div className="social-login-button">
                                <a
                                href={`${process.env.REACT_APP_BACKEND_ADDRESS}/auth/linkedin`} id="linkedin-login-button" className="social-login-link">
