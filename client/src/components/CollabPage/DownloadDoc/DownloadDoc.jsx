...
async function downloadProc(event) {
    ...
    // Blob -> ArrayBuffer
    const PDFArrayBuffer = await this.props.currentDoc.arrayBuffer();
...
const DownloadDoc = () => {
    return (
        <Button className='download-button' onClick={event => downloadProc(event)}>
            Download
        </Button>
    )
}
